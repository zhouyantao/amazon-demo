...
public class Order extends AbstractMwsObject {
     ...
     * @return This instance.
     */
    public Order withPaymentMethodDetails(String... values) {
     ...
     * @return This instance.
     */
    public Order withIsReplacementOrder(Boolean isReplacementOrder) {
        this.isReplacementOrder = isReplacementOrder;
        return this;
    }
    ...
    /** Value constructor. */
    public Order(String amazonOrderId,XMLGregorianCalendar purchaseDate,XMLGregorianCalendar lastUpdateDate,String orderStatus) {
        this.amazonOrderId = amazonOrderId;
        this.purchaseDate = purchaseDate;
        this.lastUpdateDate = lastUpdateDate;
        this.orderStatus = orderStatus;
